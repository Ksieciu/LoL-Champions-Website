        ...
        while($cond){
          //  echo '<div class="row">';
            ...
            for($i = 0; $i < 8; $i++){
                ...
                echo  '<br><button type="submit" class="fav-btn" method="Post" ><svg class="bi bi-heart" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
